...
export const API_BASE_URL_DEV_IP = 'http://192.168.1.82:8080'; // Updated with your local IP
...
export const USE_IP_ADDRESS = false; // Using IP address (more reliable - works even if ADB reverse disconnects)
