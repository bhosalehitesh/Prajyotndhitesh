          ...
          <div style={{
            ...
            <div style={{
              ...
              background: paymentMethod === 'COD' 
                ? (isDarkMode ? 'rgba(255, 243, 199, 0.1)' : '#fef3c7')
                : (isDarkMode ? 'rgba(255,255,255,0.05)' : '#fff'),
              borderRadius: '8px',
              border: `1px solid ${paymentMethod === 'COD' 
                ? (isDarkMode ? 'rgba(255, 243, 199, 0.2)' : '#fde68a')
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '12px' }}>
                <input
                  ...
                  style={{ accentColor: '#ff6d2e', cursor: 'pointer' }}
                />
                <div>
              ...
              {paymentMethod === 'COD' && (
                <div style={{
                  ...
                  Extra ₹{codCharges} charge applies. Pay ₹{(itemTotal + deliveryFee + codCharges).toLocaleString('en-IN')}
                </div>
              )}
            </div>
            ...
            <div style={{
              ...
              background: paymentMethod === 'RAZORPAY' 
                ? (isDarkMode ? 'rgba(59, 130, 246, 0.1)' : '#dbeafe')
                : (isDarkMode ? 'rgba(255,255,255,0.05)' : '#fff'),
              borderRadius: '8px',
              border: `1px solid ${paymentMethod === 'RAZORPAY' 
