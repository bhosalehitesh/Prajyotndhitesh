...
public class PaymentService {
    ...
    public Payment onPaymentSuccess(String razorpayOrderId, String razorpayPaymentId, String razorpaySignature) {
        ...
        if (verificationOrder != null && verificationOrder.getPaymentStatus() == PaymentStatus.PAID) {
            ...
            System.err.println("Expected: PAID, Actual: " + (verificationOrder != null ? verificationOrder.getPaymentStatus() : "NULL"));
    ...
    public void updatePaymentStatus(String paymentId, PaymentStatus status) {
        ...
        if (order != null && order.getOrdersId() != null) {
            ...
            if (freshOrder != null) {
                ...
                System.out.println("✅ [updatePaymentStatus] Updated order #" + freshOrder.getOrdersId() + " payment status to " + status);
            } else {
                System.err.println("❌ ERROR: Could not find order #" + order.getOrdersId() + " to update payment status");
            }
        }
    }
