...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.setAllowedOrigins(List.of(
                ...
                "http://192.168.1.38:8080",   // Network IP for React Native (current)
                "http://192.168.1.38:8081",   // Metro bundler on network IP (current)
                "http://192.168.1.38:3000",   // Frontend on network IP (current)
